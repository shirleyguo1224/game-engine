...
public class Main {
    ...
    private static Controller getController(CommandArgs options) {
        Player manualPlayer1;
        Player manualPlayer2;
        GUI gui;
        PrintStream log;
        View view;
        Reporter reporter;
        ...
        if (options.contains("--display")) {
            ...
            reporter = gui;
            gui.display(true);
            manualPlayer1 = new GUIPlayer(gui);
            manualPlayer2 = new GUIPlayer(gui);
            view = gui;
        } else {
            gui = null;
            reporter = new TextReporter();
            manualPlayer1 = new TextPlayer();
            manualPlayer2 = new TextPlayer();
            view = new NullView();
        }
        log = null;
        ...
        return new Controller(view, log, reporter, manualPlayer1, manualPlayer2);
    }
}
